...
<form method = 'GET' action = 'search_order_id.php' enctype = 'multipart/form-data'>
<div class = 'searchs'>
    <p class = 'searchl'>Order Id:</p> <input class = 'okss' type = 'text' name = 'order_id' placeholder = 'Search Order Id..' />
